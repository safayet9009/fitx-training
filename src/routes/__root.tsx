...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Gamified AI-powered fitness platform: track workouts, build streaks, level up." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "FitX — AI Fitness OS" },
      { name: "twitter:description", content: "Gamified AI-powered fitness platform: track workouts, build streaks, level up." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/mEbCbCXJRGeFSQRVVAlZxkyrdSh2/social-images/social-1782368874204-Gemini_Generated_Image_stb11stb11stb11s.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/mEbCbCXJRGeFSQRVVAlZxkyrdSh2/social-images/social-1782368874204-Gemini_Generated_Image_stb11stb11stb11s.webp" },
